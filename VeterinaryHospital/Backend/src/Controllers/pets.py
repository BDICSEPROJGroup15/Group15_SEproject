...
@pets.route('/index')
def index():
    return render_template('pets/myPets.html', title='myPets')
...
@pets.route('/pets/petcenter',methods=['GET','POST'])
def petCenter():
	form=PetForm()
	return render_template('pets/petcenter.html', title='petcenter', pets=None,form=form)